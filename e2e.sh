...
#To see all the scenarios --> bash e2e.sh 
#To deploy boutique scenario --> bash e2e.sh boutique
#To deploy log4j scenario --> bash e2e.sh log4j
#To deploy all scenarios --> bash e2e.sh all
#Use 'del' at the end to remove the scenario
#To remove boutique scenario --> bash e2e.sh boutique del
#To remove log4j scenario --> bash e2e.sh log4j del
#To remove all scenrios --> bash e2e.sh all del
...
then
  ...
  echo -e "${bold}\nUse following commands for deploying and deleting. \n\nbash e2e.sh boutique/sysrv/log4j/tntbot/all ---> to deploy scenarios\n\nbash e2e.sh boutique/sysrv/log4j/tntbot/all del ---> to delete scenarios\n\nExample:- bash e2e.sh boutique or bash e2e.sh boutique del${reset}\n"
fi
